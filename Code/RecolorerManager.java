...
class RecolorerManager{
	public static void main(String args[]) throws Exception{
		//java ColorSeparation InputImage.ext OutputImage ext targetR targetG targetB convertR convertG convertB <optional-not shown>convert Alpha
        	...
        	Runtime.getRuntime().exec("java ColorSeparation Test.png WhiteLightning png 255 216 0 255 255 255");
        	Runtime.getRuntime().exec("java ColorSeparation Test.png WhiteLightning jpg 255 216 0 255 255 255");
